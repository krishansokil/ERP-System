  ...
  .body-pd{
    ...
    <body id="body-pd"> 
        <header class="header" id="header">
            ...
            <div class="header__toggle">
                <p class="alert-heading">Welcome - <?php echo $_SESSION['rollno']?></p>
            </div>
            <a href="student_logout.php" class="header_toggle">
        ...
        <div class="l-navbar" id="nav-bar">
            <nav class="nav">
                <div>
                    <div class="nav__list">
                        <a href="student_dashbord.php" class="nav__link active">
