  ...
  .body-pd{
    ...
    <body id="body-pd"> 
        <header class="header" id="header">
            ...
            <div class="header__toggle">
                <p class="alert-heading">Welcome - <?php echo $_SESSION['full_name']?></p>
            </div>
            <div>
            <a href="faculty_logout.php" class="header_toggle">
        ...
        <div class="l-navbar" id="nav-bar">
            <nav class="nav">
                <div>
                    <div class="nav__list">
                        <a href="faculty_dashbord.php" class="nav__link active">
                        <i class='fas fa-fw fa-home' ></i>
                            <span class="nav__name">Dashboard</span>
                        </a>
                        <a href="faculty_profile.php" class="nav__link">
                        <i class="iconify" data-icon="mdi:account" data-inline="false"></i>
                            <span class="nav__name">My Profile</span>
                        </a>
                        <a href="faculty_fill_attendance.php" class="nav__link">
                        ...
                        <a href="faculty_timetable.php" class="nav__link">
