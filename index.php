...
<link rel="stylesheet" href="fonts/font-awesome.css"> <!-- Font-Awesome-Icons-CSS -->
...
<div class="main_section_agile" id="home">
	<div class="agileits_w3layouts_banner_nav">
		<nav class="navbar navbar-default">
			...
			<h1><a class="navbar-brand" href="index.html"><i class="fa fa-leanpub" aria-hidden="true"></i> SBCET</a></h1>
			...
			<ul class="agile_forms">
				<li><a class="active" href="student_login.php"><i class="fa fa-sign-in" aria-hidden="true"></i> Sign In now</a> </li>
	...
	<div class="container">
		...
		<div class="col-md-7 wthree-services-bottom-grids">
			<div class="wthree-services-left">
				<img src="images/ab1.jpg" style="height: 380px; width: 520px;" alt="">
			</div>
			<div class="wthree-services-right">
				<img src="images/1.jpg" style="height: 323px; width: 520px;" alt="">
			</div>
			<div class="clearfix"> </div>
		</div>
		<div class="col-md-5 wthree-about-grids">
			<h4>Welcome to Our College</h4>
			<a href="https://sbss.ac.in/" class="trend-w3l" data-toggle="modal" data-target="#myModal"><span>Read More</span></a>
	...
	<div class="container">  
		...
		<div class="services-w3ls-row">
			<div class="col-xs-4 services-grid agileits-w3layouts">
				...
				<a href="student_login.php" onMouseOver="this.style.color='yellow'" onMouseOut="this.style.color='blue'" style="font-weight: bold">STUDENT PANEL</a>
			</div>
			<div class="col-xs-4 services-grid agileits-w3layouts">
				<h6>02</h6>
				<h5>Skilled Lecturers</h5>
				<a href="faculty_login.php" onMouseOver="this.style.color='yellow'" onMouseOut="this.style.color='blue'" style="font-weight: bold">FACULTY PANEL</a><br>
			...
			<div class="col-xs-4 services-grid agileits-w3layouts">
				...
				<a href="admin_login.php" onMouseOver="this.style.color='yellow'" onMouseOut="this.style.color='blue'" style="font-weight: bold">MANAGEMENT</a>
			</div> 
			<div class="clearfix"> </div>
		</div>  
	</div>
...
<section class="portfolio-w3ls" id="gallery">
		...
		<div class="w3layouts_header">
			<p><i class="fa fa-graduation-cap" aria-hidden="true"></i></p>
				...
				<div class="col-md-4 col-xs-4 gallery-grid gallery1">
					<a href="images/g1.jpg" class="swipebox"><img src="images/1.jpg" class="img-responsive" alt="/" style="height: 262px; width: 500px;">
						<div class="textbox">
						<h4>scholarly</h4>
				...
				<div class="col-md-4 col-xs-4 gallery-grid gallery1">
					<a href="images/g2.jpg" class="swipebox"><img src="images/3.jpeg" class="img-responsive" alt="/" style="height: 262px; width: 500px;">
						<div class="textbox">
						<h4>scholarly</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-4 col-xs-4 gallery-grid gallery1">
					<a href="images/g3.jpg" class="swipebox"><img src="images/sbss.jpg" class="img-responsive" alt="/" style="height: 262px; width: 500px;">
						<div class="textbox">
						<h4>scholarly</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-4 col-xs-4 gallery-grid gallery1">
					<a href="images/g5.jpg" class="swipebox"><img src="images/faculty.jpeg" class="img-responsive" alt="/" style="height: 262px; width: 500px;">
						<div class="textbox">
						<h4>scholarly</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-4 col-xs-4 gallery-grid gallery1">
					<a href="images/g6.jpg" class="swipebox"><img src="images/g6.jpg" class="img-responsive" alt="/" style="height: 262px; width: 500px;">
						<div class="textbox">
						<h4>scholarly</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
					   </div>
				...
				<div class="col-md-4 col-xs-4 gallery-grid gallery1">
					<a href="images/g11.jpg" class="swipebox"><img src="images/labs.jpeg" class="img-responsive" alt="/" style="height: 262px; width: 500px;">
						<div class="textbox">
						<h4>scholarly</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
					   </div>
	...
	<div class="container">
		...
		<div class="team-w3l-grid">
			<div class="col-md-4 col-xs-4 about-poleft t1">
				<div class="about_img"><img src="images/faq_man.png" alt="">
				  <h5>Faculty 1</h5>
				  <div class="about_opa">
					<p>Professor</p>
		...
		<div class="agile_banner_bottom_grids">
			<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
				...
				<div class="agile_contact_grid_right agilew3_contact">
					<h4>Address</h4>
					<p><?php echo "Benad Road, Via Dadi Ka Phatak,
Jaipur, Rajasthan, PIN-302013"; ?></p>
					<p></p>
				</div>
			</div>
			<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
				...
				<div class="agile_contact_grid_right agileits_w3layouts_right">
					<h4>Phone</h4>
					<p><?php echo "<br>"; ?> <span><?php echo "+91-141-2972260, 2972261"; ?></span></p>
				</div>
			</div>
			<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
				...
				<div class="agile_contact_grid_right agileits_w3layouts_right1">
					<h4>Email</h4>
					<p><a href="mailto:info@example.com"><?php echo "Enquiry Email"; ?></a>
						<span><a href="mailto:info@example.com"><?php echo "admin@sbss.ac.in"; ?></a></span></p>
				</div>
				<div class="clearfix"> </div>
			</div>
			<div class="clearfix"> </div>
		...
		<div class="w3l-form">
            ...
            <button class="btn btn-dark" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample"><a href="mailto:admin@sbss.ac.in"></a>
    Send
  </button>
					</form>
				</div>
	...
	<div class="container">
		<div class="wthree_footer_grid_left">
			<div class="col-md-4 col-xs-4 wthree_footer_grid_left1">
				<h4>About Us</h4>
				<p><?php echo "Sri Balaji College of Engineering & Technology, Jaipur is one of the pioneer institutions of engineering & technology. The college was established in in 2000 with the approval of the All India Technical Education Council (AICTE), New Delhi."; ?></p>
			</div>
			<div class="col-md-4 col-xs-4 wthree_footer_grid_left1">
				<h4>Navigation</h4>
				<ul>
			...
			<div class="col-md-4 col-xs-4 wthree_footer_grid_left1 wthree_footer_grid_right1">
				<h4>Contact Us</h4>
				<ul>
					<li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:admin@sbss.ac.in"></a><?php echo "admin@sbss.ac.in"; ?></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i><?php echo "+91-141-2972260, 2972261"; ?></li>
					<li><i class="fa fa-fax" aria-hidden="true"></i><?php echo "Benad Road, Via Dadi Ka Phatak,
Jaipur, Rajasthan, PIN-302013"; ?></li>
				</ul>
			</div>
			<div class="clearfix"> </div>
		</div>
...
<div class="w3layouts_copy_right">
	<div class="container">
		<p>© - 2021 All rights reserved | Design by <a href="#">MANKRIS.</a></p>
	</div>
</div>
...
<!-- Map-JavaScript -->
			...
			<script type="text/javascript">
				...
				function init() {
					var mapOptions = {
						zoom: 11,
						center: new google.maps.LatLng(26.9911, 75.7429),
					...
					var marker = new google.maps.Marker({
						position: new google.maps.LatLng(26.9911, 75.7429),
						map: map,
					});
				}
			</script>
